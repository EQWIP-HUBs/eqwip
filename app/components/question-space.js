...
export default Ember.Component.extend({
  ...
  questions: {
    'Zara': {
      1: {
        questionText: "Working from home, Zara earns an average of GHC800 per month. She has just started an entrepreneurship training program with EQWIP HUBs, to better prepare her to launch her business. <br><br> Her husband has agreed to give her access to GHC1100 of their shared personal savings, but she will need much more cash to set up her business. In addition to renting a space, she’ll also need to furnish it, and purchase supplies and equipment. <br><br> She crunches the numbers, and figures she will need access to about GHC5000, after rent. <br><br> Unfortunately, high interest rates, mandatory collateral requirements, and other bureaucratic obstacles make it all but impossible for young female entrepreneurs to access credit through formal financial institutions in Northern Ghana. Therefore, most young entrepreneurs must rely on the help of relatives and friends, or access credit through informal alternatives.",
        answerOptions: [
          {
      ...
      4: {
        questionText: "Five women have signed up for Zara’s first vocational training course, which is set to begin on May 1st. A slow start, but a start nonetheless. <br><br>One of Zara’s customers connects her with a woman who is looking for a makeup artist to service her bridal party. The woman lives in a small town near Bolgatanga, about 150km from Tamale. The artist she had previously booked cancelled on her last minute. Now, she is willing to pay GHC800 for an makeup artist willing to travel to for gig — the day after tomorrow! <br><br>Zara is on the fence. She needs the cash, but traveling around Northern Ghana is not easy, especially with children.",
        answerOptions: [
          {
          ...
          },
          {
            ...
            resultText: "Despite her family’s admonishment, Zara and her children take the Metro Mass Transit bus to Bolgatanga (GHC45). Next, she hires a Yellow Yellow to take them to the wedding venue, which is located a few kilometers outside of town. The driver charges you extra for the two children and all your supplies (GHC10). <br><br> The journey to the venue is long, hot, and uncomfortable, but Zara arrives just in time, with two upset children in tow. <br><br>After the job, Zara embarks home, arriving after midnight, exhausted. (GHC55). The next day, she will have to call and apologize to the customers whose appointments she cancelled without notice.",
            impact: {
              cash: 600,
              income: -50,
              resilience: -1,
      ...
      6: {
        ...
        questionText: "Zara’s marketing efforts seem to be working. Within a month, 10 more young women have signed up for the 2-week training program (GHC4000) and another 5 have signed up for one-day introductory courses (GHC200). <br><br>This means a major bump in Zara’s revenue, and a bump in her operating expenses, too. She needs to buy more chairs, more equipment, and more supplies (GHC2500). <br><br>She also needs help! There is no way she can teach all these young women by herself, and keep up with her regular clients.",
        answerOptions: [
          {
          ...
          },
          {
            ...
            resultText: "The apprenticeship program is a hit! Zara’s students are grateful for the opportunity to practice on real customers, and the customers are happy to pay a reduced fee.<br><br> At the end of the month, Zara finds that she is missing GHC600 in cash. She can only assume that one (or more) of the apprentices has been stealing from her. Without another staff member to assist her, she had no choice but to allow her more advanced students to handle some of the cash from walk-in clients. <br><br>Zara realizes that she needs to tighten up the way she administers her business and supervises her students.",
            impact: {
              cash: 1100,
              resilience: -1,
              assets: 1,
        ...
        answerOptions: [
          {
            ...
            resultText: "Sandra turns out to be a terrific teacher and mentor for Zara’s students — her environmental training sessions are a big hit, not only for the students, but on social media as well. <br><br> As an end of the month bonus, Zara also notices that her hydro bill has dropped, significantly.",
            impact: {
              income: -125,
              resilience: 2,
              environment: 2,
          ...
          },
          {
            ...
            resultText: "Zara does her best to convince her students to be more careful with water, and to be conscious of what they do with their waste. Though some students seem to get the message, it doesn't click with others. <br><br>She can’t help but notice, now, that her hydro bill has risen significantly in recent months (GHC25 per month).",
            impact: {
              income: -25,
              resilience: -1,
              environment: -1,
      ...
      9: {
        questionText: "Zara’s cousin is getting married this month, and has asked her to be the makeup artist for his wife and her bridal party. Zara emails him a quote for GHC500. <br><br> He does not respond to the email. A week later, he confronts Zara at work, claiming that he is insulted that she would ask a family member to pay for her services. He angrily demands that she do the work for free.",
        answerOptions: [
          {
            ...
            resultText: "Zara’s cousin apologizes for getting upset. He thanks her graciously, and leaves. Zara will have to lose a day’s income to work the wedding <i>pro bono</i> (GHC500).",
            impact: {
              cash: -500,
              resilience: -1,
            },
      ...
      11: {
        optionalText: {
          toggle: 'wentToAccra',
          whenFalse: "<i>Zara’s high school friend, who is visiting Tamale from Accra, brings her a small case of organic makeup products from a specialized manufacturer in the South. </i> <br><br> <i>Zara’s students and customers love the organic products. They’re easy to use, and better for both skin and the environment. </i>",
        ...
        answerOptions: [
          {
            ...
            resultText: "Zara will now have to spend over GHC150 per month on freight, and her supply budget has also increased. Even if she raises her prices slightly, her business’s profit margin will have thinned out. <br><br>She is confident, however, that the availability of environmentally friendly, organic products, will attract new customers, and improve the reputation of her beauty bar. She designs a new social media campaign to promote the value of the organic products she sells.",
            impact: {
              cash: -100,
              resilience: 3,
              environment: 1
      ...
      12: {
        ...
        questionText: "<br><br> As the new year approaches, she wants to set an ambitious, long-term goal on which to focus her efforts in the coming months. She consults with her students, clients, and colleagues for ideas, and comes up with two options.",
        answerOptions: [
          {
            ...
            resultText: "First thing’s first — Zara will need to purchase a computer (GHC1200 for a new laptop), a webcam (GHC100), and an internet package (GHC35 a month). This is a major investment, but Zara can use the computer for a number of additional purposes, like accounting and managing social media. <br><br>Next, Zara will need to film a number of brief tutorials to load onto YouTube and share on social media. These will be used as promotional materials, and as a way to draw in potential students for online training. <br><br>Once she has established a presence online, Zara can begin creating a online vocational training program that will require payment to access. She may have to hire a web developer down the road to help create an effective platform for her courses.",
            impact: {
              cash: -1300,
              income: -35,
              resilience: 3,
    ...
    'Kojo': {
      ...
      2: {
        ...
        answerOptions: [
          ...
          {
            text: "<b>Enroll in a coding bootcamp</b>, and learn how to build the app ‘in-house’. The Code School is offering an 8-week intensive program. The program, which starts at the beginning of next month, costs GHC1000 up front. He will also have to purchase a laptop (GHC1100).",
      ...
      7: {
        ...
        answerOptions: [
          {
            text: "Purchase specially outfitted plastic recycle bins from RWS, and install them in strategic locations — next to open drains or near busy marketplaces. <br><br> This won’t be a cheap endeavor — in addition to purchasing the bins, Kojo will also have to hire a Motorking driver to make weekly pickups (RWS trucks will not be able to operate in these busy areas). He will also have to hire a number individuals to teach and encourage Accrans how to properly use the bins once they are introduced! In total, Kojo estimates that he will need to fork over about GHC500 to pull this off.",
      ...
      10: {
        questionText: "One of Kojo’s colleagues from the bootcamp invites him to take part in a hackathon — a weekend event where teams of computer coders, programmers, designers, and social entrepreneurs compete to develop a viable web or mobile based computer program. The hackathon, which will be held at the U-Code computer lab in Accra, will be judged by an esteemed panel of local and international judges. <br><br> The contest costs GHC350 to enter. The hackathon will be highly competitive, but the winning team will get to work with business experts and a tech incubator to further develop their idea.",
        answerOptions: [
          {
      ...
      12: {
        ...
        alternate: {
          questionText: "As the end of the year approaches, Kojo decides, at last, to reach out to potential investors. His business proposal is ready, his suit is pressed, and he has perfected his elevator pitch. <br>Kojo sets up a meetings with a list of organizations and companies provided to him by the business consultant. Some meetings go better than others, but in the end, Kojo has to decide between two offers.",
          answerOptions: [
            {
              text: "A private waste collection and processings firm that operates nation-wide offers GHC50,000 to purchase Recycle Accra!, and adapt the technology to service their own operations. Kojo will retain a 10% stake in the company, and will stay on board as an ‘advisor’",
              resultText: "Wow! GHC50,000 is a lot of money. Kojo will be able to pay back his debts, upgrade his tech equipment, and help his family out with some of their expenses. <br><br>Unfortunately, the private waste company does not seem interested in giving Kojo much of a say regarding their use of his application. Though officially an ‘advisor’, he suspects that this does not give him very much influence. <br><br>Fortunately, Kojo now has more than enough cash to invest in a new enterprise. Over the next several months, he plans to sign up for additional coding course, and has already signed up for an entrepreneurship training program. Now that he has extensive experience and a solid network, he hopes to put together a team of like-minded young entrepreneurs with which to develop new and innovative tech-based social enterprises.<br><br>Kojo thinks the future looks bright. <br><br>Click here to take a closer look at how Kojo’s business fared over the past twelve months.",
              impactImage: "Loan_Lundy.png",
              impact: {
                cash: 50000,
                resilience: -3,
            ...
            {
              text: "A small tech incubator offers Kojo GHC10,000 in seed funding in exchange for 20% of Recycle Accra! In addition to seed funding, the incubator will also provide Kojo with the space, support, and mentorship he will need to take the business to the next level.",
              resultText: "Kojo is thrilled by this offer. GHC10,000 provides him with enough cash to service his debts, upgrade his equipment, and invest in further expanding and marketing Recycle Accra! <br><br>Though it was tough to turn down a significantly larger cash offer, Kojo is relieved that he will not have to cede control of the project he worked so hard to build. Indeed, he now has access to an incredible tech lab, an extensive network of fellow entrepreneurs and mentors, and the support of a incubator that wants his business to succeed. <br><br>Kojo thinks the future looks bright.<br><br>Click here to take a closer look at how Kojo’s business fared over the past twelve months.",
              impactImage: "Loan_Lundy.png",
              impact: {
                cash: 10000,
                resilience: 3,
        ...
        answerOptions: [
          {
            text: "A waste collection and recycling firm that is partnered with the municipal government offers Kojo GHC50,000 to purchase Recycle Accra!, which they will adapt to their city-wide services. Kojo will retain a 10% stake in the business, and will be kept on as an ‘advisor’.",
            resultText: "Wow! GHC50,000 is a lot of money. Kojo will be able to pay back his debts, upgrade his tech equipment, and help his family out with some of their expenses. <br><br>Unfortunately, the waste company does not seem interested in giving Kojo much of a say regarding their use of his application. Though officially an ‘advisor’, he suspects that this does not give him very much influence. <br><br>Fortunately, Kojo now has more than enough cash to invest in a new enterprise. Over the next several months, he plans to sign up for additional coding course, and has already signed up for an entrepreneurship training program. Now that he has extensive experience and a solid network, he hopes to put together a team of like-minded young entrepreneurs with which to develop new and innovative tech-based social enterprises. <br><br>Kojo thinks the future looks bright. <br><br>Click here to take a closer look at how Kojo’s business fared over the past twelve months.",
            impactImage: "Loan_Lundy.png",
            impact: {
              cash: 50000,
              resilience: -3,
          ...
          {
            text: "An international NGO dedicated to fostering environmental sustainability throughout Ghana and West Africa offers to partner with Kojo. They offer him GHC5,000 in seed capital to grow and expand Recycle Accra!, and a two-year salaried position (GHC1,200/month) as a technology and innovation advisor.",
            resultText: "Kojo is thrilled by this offer. GHC5,000, plus a monthly salary, will provide him with enough cash to service his debts, upgrade his equipment, and invest in expanding and marketing Recycle Accra! <br><br> Though it was tough to turn down a significantly larger cash offer, Kojo is relieved that he will not have to cede control of the project he worked so hard to build. Indeed, as an employee of a major NGO, he will now be able to leverage the support of an impressive and diverse network of professionals to not only expand Recycle Accra!, but also build new and innovative social enterprises. <br><br> Kojo thinks the future looks bright. <br><br>Click here to take a closer look at how Kojo’s business fared over the past twelve months.",
            impactImage: "Loan_Lundy.png",
            impact: {
              cash: 5000, //only changed here
              resilience: 3,
            },
          },
        ]
    ...
    'Lamisi': {
      1: {
        questionText: "Lamisi has GHC500 in savings, all of which she is willing to invest in her poultry farm. She’s been raising chicks in her family’s yard for the last few months, and now has about twenty full grown birds. <br><br> Now, she must build a small bird pen and a series of troughs for water and feed. She uses wooden planks and barbed wire to keep costs low (GHC300). Next, she buys 25 more day-old chicks from a local hatchery, and enough feed to raise them (GHC200). These chicks will take between 4 to 6 months to mature, after which they will be able to lay eggs for up two years. <br><br> Lamisi expects her flock to eventually produce about one crate of eggs per day, which she can sell for about GHC14. She can also sell her older birds for GHC25 each. <br><br> She crunches the numbers. Taking into account the cost of feed and other expenses, Lamisi expects to turn a profit of about GHC340 per month by the end of June.",
        answerOptions: [
          {
        ...
        answerOptions: [
          {
            ...
            resultText: "It’s not cheap, but Lamisi feels good about being a responsible steward of the environment. <br><br> After a few weeks of collecting waste, she decides to reach out to her neighbor and family friend, who rears cattle, so she can learn how to process the waste into manure. He is happy to help.<br><br> Though it’s a lot of extra work, Lamisi can now sell her manure, or use it to fertilize her family’s vegetable garden. (Cash up)",
            impact: {
              cash: -250,
              income: 30,
              resilience: 2,
          ...
          },
          {
            ...
            resultText: "Lamisi saved a buck, but at the expense of the natural environment, on which she and her neighbors depend. On hot days, the stench from her farm is enough to turn away customers. Nor are her neighbors impressed. <br><br> Lamisi may come to regret this choice yet.",
            impact: {
              environment: -1
            }
          },
        ...
        answerOptions: [
          {
            ...
            resultText: "Though hesitant, the manager offers to give Lamisi a shot — what does he have to lose? <br><br> After sampling her product, he agrees to do business. He offers to purchase a supply of 12 birds a month at a price of GHC25 each. He praises her confidence and initiative. <br><br> Before signing the contract, Lamisi agrees to pay for a veterinarian to assess the health of her birds (GHC350), and hires a Motorking driver to make her deliveries once a week (GHC40/month).",
            impactImage: "Loan_Lundy.png",
            impact: {
              cash: -350,
              income: 225,
      ...
      5: {
        optionalText: {
          ...
          whenTrue: "Now that Lamisi needs to supply a restaurant with live birds, she needs to expand the size of her pen, and purchase additional chicks and feed. To do this, she will need more cash."
        },

        questionText: "<br><br> Unfortunately, high interest rates, negative attitudes towards women in business, and other bureaucratic obstacles make it all but impossible for young female entrepreneurs to access credit through formal financial institutions in northern Ghana. Therefore, most young entrepreneurs must rely on the help of relatives and friends, or access credit through informal alternatives.",
        answerOptions: [
          {
            text: "Reach out to family for a loan.",          
            resultText: "Lamisi’s parents deny her request for a loan. Though they have come to term with the fact that she is running a small poultry operation in the yard, they do not think that she will be able to run a successful farm on a larger scale. <br><br> Lamisi reluctantly decides to ask her long-time friend, who owns a local catering company, for a loan. He agrees to loan her GHC1000, which she will pay back, with interest, in installments of GHC100 per month for one year. <br><br> Lamisi is relieved to have found a source of cash to invest in her business. She spends GHC150 expanding her pen and purchasing additional feed.",
            impact: {
              cash: 850,
              resilience: 3,
              debt: 1200,
       ...
       answerOptions: [
         {
           text: "Get the paperwork together, and register! To operate legally, Lamisi will need to apply for a Tax Identification Number (GHC25) and register her business as a sole proprietorship (GHC35).",
            resultText: "Lamisi spends most of her weekend sorting her way through the convoluted application paperwork. On Monday, she heads to the registration office, but there is a massive queue. She waits for several hours, but the queue barely moves. She’s one of the only women present in the queue, and a couple of men begin to harass and tease her. Frustrated and tired, Lamisi decides to go home. <br><br> The next day, determined to properly register her business, Lamisi decides to hire a man that will wait in line at the office on her behalf. This costs her an extra (GHC50), but it does the trick. A few weeks later, her application is accepted.",
            impact: {
              cash: -110,
              resilience: 2,
            }
      ...
      7: {
        ...
        alternate: {
          ...
          questionText: "Lamisi’s younger sister has just started Junior High School, and her fees are due (GHC150). As the older sister, Lamisi is expected to cover the school fees. <br><br> However, just as the rainy season is coming to a close, a number of her layer birds fall sick. Lamisi will either have to hire a veterinarian to tend to the sick birds (GHC300), or let them die.",
          questionImage:"School_Lundy.png",
          answerOptions: [
            {
      ...
      // esoko
      8: {
       questionText: "One of the traders in Lamisi’s Susu circle tells her about <a target='_blank' href='http://www.ghanaweb.com/GhanaHomePage/business/DKM-customers-threaten-demo-over-non-payment-of-claims-490980'>Esoko</a> — a mobile agribusiness tool that connects smallholder farmers with businesses, governments, and NGOs. Farmers can sign up using their cell phone to access key information about market prices, weather forecasts, agronomic tips, crop calendars, market trends, and more. <br><br> <a target='_blank' href='http://citifmonline.com/2016/08/25/esoko-opens-branch-in-tamale-to-boost-agribusiness/'> Esoko just opened a branch in Tamales </a>, the trader explains. Esoko’s Managing Director claims that the branch was established to bridge the gap in information flow between smallholder farmers and key players in the agricultural value chain. <br><br> This sounds like a great opportunity! Unfortunately, Esoko is designed to work most efficiently with smartphones — Lamisi only has a ‘yam’.",
       answerOptions: [
         {
      ...
      9: {
        questionText: "The rainy season is ending, and the Harmattan — a dry and dusty northeasterly trade wind that blows from the Sahara over West Africa from December to March — is on its way. The hot, dry weather will make it difficult for Lamisi’s birds to thrive, and the farm’s production will likely suffer. <br><br>Lamisi begins to worry about the sustainability of her business. The market has become saturated — services like Esoko have made it easier for new entrepreneurs to enter the market, further eating into her demand. <br><br>Lamisi must find a new way to innovate — to bring something new or different to the table. She reaches out to customers, restaurant owners, and wholesalers, in order to find out how to better improve her business.<br><br> <br><br>Lamisi’s research produces some interesting findings. First, she learns that most restaurants, hotels, and households in urban areas in Northern Ghana rely on frozen poultry products imported from the South or from overseas — these products are typically cheaper, pre-cut, processed, and ready to use. <br><br>However, customers and restaurants also reported a preference for local, fresh poultry, even if it is a bit more expensive. Many customers believe that fresh poultry is healthier than the frozen kind. However, frozen poultry is considered more convenient and more reliable. Plus, customers do not want to kill or prepare their own birds.<br><br> <br><br>Lamisi comes up with two ways to make use of these findings:",
        answerOptions: [
          {
            ...
            resultText: "For this scheme to work, Lamisi will need to produce goods that are as healthy and high quality as advertised! <br><br> After consulting with some more experienced farmers and doing some research online, she replaces many of the low-cost ingredients in her feed mix with higher-quality, organic products, and also begins to add herbal supplements to her birds’ water supply. (GHC150 per month). She also further expands her pen to create more space for her birds to roam (GHC150). <br><br> Lamisi will eventually have to raise her prices, but not just yet.",
            impact: {
              cash: -150,
              income: -150,
              resilience: 3,
      ...
      10: {
        ...
        alternate: {
          ...
          answerOptions: [
            ...
            {
              text: "One of the traders in Lamisi’s Susu circle works as a distributer of <i>Brukina</i> — a popular millet-based drink and breakfast substitute. She works closely with a Motorking driver who delivers Brukina throughout the region for a good rate. <br><br> Offer your friend’s driver GHC35 a month to add the poultry products to his regular route. Lamisi can save money on transport, and the driver will be happy for the extra cash.",
              resultText: "The scheme backfires. On the second week, the delivery driver collides with another vehicle, and Lamisi’s eggs are crushed by a tumbling crate of Brukina. She loses a week’s profit, and the restaurant managers are <i>not</i> happy. <br><br> One of them terminates the contract.",
              impact: {
              }
            },
          ]
      ...
      11: {
        ...
        questionText: "Lamisi’s cousin, who is getting married next week, drops by the farm and asks her to provide a half dozen birds for the occasion. <br><br> She is happy to oblige, and offers the half-dozen birds for a price of GHC150. Her cousin gets upset, and claims that he is offended that she would try to charge a family member, as if he was just another customer. He re-asserts that she should give the birds to him for free. ",
        answerOptions: [
          {
      ...
      12: {
        ...
        questionText: "The Harmattan passes, and Lamisi’s business is humming. However, over the past several weeks, she’s watched with anxiety as the price of white corn — a key ingredient in her new bird feed mix — steadily inflates. <br><br> A 100kg bag of white corn, which cost her just GHC55 just 3 months ago, now costs GHC100. It looks like the price of soybean meal is also on the rise. <br><br> It doesn’t look like Lamisi will be able to sustain her business model with these key prices on the rise.",
        answerOptions: [
          {
  ...
  setDialogContent(whichModal) {
    ...
    // Below variable is added to make model key value finding easier
    // by looping over a object.
    let newModalContentObj ={
      familyOfFarmers : 'This is dummy content'
    };
  
    console.log('Family of Farmers');
    console.log(whichModal);
    for(let key in newModalContentObj){
      if(whichModal == 'familyOfFarmers'){
        this.set(newModalContentObj[key]);
      }
    }
